...
calibration table. The default anchors are community approximations; refining
them against a real Live set is deferred. The load-bearing anchors are
0 dB ~= 0.85 and +6 dB = 1.0.
"""

# (live_value, dB) anchors, ascending. Refine against a real set later.
_VOLUME_ANCHORS = [
    (0.0, -70.0),
    (0.2, -50.0),
    (0.4, -25.0),
